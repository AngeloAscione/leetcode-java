...
|--topics/
|   |
|   |--01_arrays_hashing_strings/
|   |   |
|   |   |-easy/      (Fundamentals & Warm-ups)
...
1. Efficiency: Is the Time/Space complexity optimal?
2. Readability: Is the code maintainable and idiomatic Java?
3. Edge Cases: How does the algorithm handle nulls, overflows, or malicious inputs?
4. Implementation: Do I understand the underlying HashMap or HashSet mechanics?

## 📊 Roadmap & Progress
| Category | Easy | Medium | Hard | Status |
| :--- | :---: | :---: | :---: | :---: |
| Arrays & Hashing | 🟢 | ⚪ | ⚪ | In Progress |
| Two Pointers | ⚪ | ⚪ | ⚪ | To Start |
